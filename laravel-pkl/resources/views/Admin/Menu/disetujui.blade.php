                  ...
                  <table id="example2" class="table table-bordered table-hover">
                    <thead>
                      ...
                      <tr>
                        ...
                        <td>
                          <center>
                            <a href="berkas/{{ $s->persyaratan }}"  class="btn btn-sm btn-primary"><i class="fas fa-file-pdf"> view</i></a>
                          </center>
                        </td>
                        <td>
                          <center>
                            <a href="berkas/{{ $s->proposal }}" class="btn btn-sm btn-primary"><i class="fas fa-file-pdf"> view</i></a>
                          </center>
                        </td>
                       
                        <td>{{ $s->tanggal }}</td>
                        <td>
                          <center><a href="berkas/{{ $s->keterangan }}"><i></i></a></center>
                        </td>
                        <td>@if ($s->status == 0)
                            Menunggu
                            @elseif($s->status == 1)
                        ...
                        <td>
                            @if($s->status == 0)
                            <a href="/disetujui/{{ $s->id }}/setuju" class="btn btn-xs btn-success">Setujui</a>
                            @endif
                            @if($s->status == 0)
                          <a href="/disetujui/{{ $s->id }}/revisi" class="btn btn-xs btn-primary">Revisi</a>
                          @endif
                            @if($s->status == 0)
                          <a href="/disetujui/{{ $s->id }}/tolak" class="btn btn-xs btn-danger">Tolak</a>
                          @endif
